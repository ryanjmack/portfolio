    ...
    return (
      <main className='Contact'>
        <div className='Contact__content'>
          ...
          <p className='Contact__email'>Want to talk? <a href="mailto:mackry@oregonstate.edu">Send me a message!</a></p>
        </div>
      </main>
    );
  }
